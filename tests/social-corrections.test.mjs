...
test("only exact new approval, source and renewed authority accept the approved caption",()=>{
  ...
  assert.deepEqual(Object.keys(selectedPolicy.exactApprovedCaptions).sort(),[internalId,"ST-CHIEF-BABYSITTING-ENGINEER","ST-LAUNDRY-FROM-WORK","ST-SIX-FIGURE-GROWTH"]);
